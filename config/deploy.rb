...
set :application, "mina_test_540"
set :application_name, "mina_test_540"  # Required for mina-puma-nginx gem
set :repository, 'git@github.com:railsblueprint/rb-mina-test-1752972540.git'
